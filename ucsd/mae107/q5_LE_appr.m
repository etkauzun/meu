function [approx, error, log_err, log_n] = q5_LE_appr(a,b,n)
% q5_trap_appr computes the LE approximation for a given function
%
% Call format: [approx,error,log_err,log_n] = q5_LE_appr(a,b,n)
%
% input variables:
