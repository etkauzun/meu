function [approx, error, log_err, log_n] = q7_trap_appr(a,b,n)
% q7_trap_appr computes the trapezoid approximation for a given function
%
% Call format: [approx,error,log_err,log_n] = q7_trap_appr(a,b,n)
%
% input variables:
