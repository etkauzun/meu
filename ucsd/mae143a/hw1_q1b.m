...
plot3(sqrt(b*(rbar-1)),sqrt(b*(rbar-1)),-1,'r*');    % first equilibrium point
plot3(-1*sqrt(b*(rbar-1)),-1*sqrt(b*(rbar-1)),-1,'r*'); % second equilibrium point
plot3(0,0,-1*rbar,'r*');    % third equilibrium point
for t=0:h:T
