...
% THIS IS THE POSITION OF EACH JOINT WITH FROM & ONE OF THEM BEING THE ORIGIN
nodes = [0,0;
         2,2*sin(45);
         2,0;
         6,0];
...
% THIS SHOWS WHICH JOINT IS CONNECTED TO WHICH (E.G. 1 TO 2, 2 TO 3,ETC)
% OR LISTING THE MEMBER TRUSSES (GO RESPECTIVELY)
elements = [1,2;
            2,3;
            2,4;
            1,3;
...
% THIS IS THE REACTION FORCES (E.G. THERE IS A REACTION FORCE AT THE FIRST
% JOINT IN X&Y DIRECTIONS)
BCs = [1,2;
       0,0;
       0,0;
       0,3];
